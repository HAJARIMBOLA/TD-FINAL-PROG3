...
public class CollectivityController {
    ...
    public ResponseEntity<?> getLocalStatistics(@PathVariable String id,
                                                ...
                                                @RequestParam LocalDate to) {
        try {
            return ResponseEntity.status(OK).body(statisticsService.getLocalStatistics(id, from, to));
        } catch (BadRequestException e) {
            return ResponseEntity.status(BAD_REQUEST).body(e.getMessage());
        } catch (NotFoundException e) {
            return ResponseEntity.status(NOT_FOUND).body(e.getMessage());
    ...
    public ResponseEntity<?> getOverallStatistics(@RequestParam LocalDate from,
                                                  @RequestParam LocalDate to) {
        try {
            return ResponseEntity.status(OK).body(statisticsService.getOverallStatistics(from, to));
        } catch (BadRequestException e) {
            return ResponseEntity.status(BAD_REQUEST).body(e.getMessage());
        } catch (NotFoundException e) {
            return ResponseEntity.status(NOT_FOUND).body(e.getMessage());
